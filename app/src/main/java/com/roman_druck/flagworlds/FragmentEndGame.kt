...
class FragmentEndGame : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sharedPref= activity!!.getSharedPreferences("fwprefs", Context.MODE_PRIVATE)
    }
    ...
    fun fillPage(v: View) {
        ...
        tv = v.findViewById(R.id.tvVerdict)
        ...
        tv = v.findViewById(R.id.tvFirstPlaceName)
        tv.text = namesHi[0]
        tv = v.findViewById(R.id.tvFirstPlacePoints)
        tv.text = activity!!.getString(R.string.correctFlags, pointsHi[0].toString())
        tv = v.findViewById(R.id.tvSecondPlaceName)
        tv.text = namesHi[1]
        tv = v.findViewById(R.id.tvSecondPlacePoints)
        tv.text = activity!!.getString(R.string.correctFlags, pointsHi[1].toString())
        tv = v.findViewById(R.id.tvThirdPlaceName)
        tv.text = namesHi[2]
        tv = v.findViewById(R.id.tvThirdPlacePoints)
        tv.text = activity!!.getString(R.string.correctFlags, pointsHi[2].toString())
        tv = v.findViewById(R.id.tvPersonalBest)
